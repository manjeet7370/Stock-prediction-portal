...
const Dashboard = () => {
    ...
    const [day30Price, setDay30Price] = useState()
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            ...
            setNextPrice(response.data.next_day_price)
            setDay30Price(response.data.day_30_price)
        ...
        <div className="row">
            ...
            {prediction && (
                ...
                <div className="text-light p-3">
                   ...
                   <p>Today Price: ₹ {todayPrice?.toFixed(2)}</p>
                    <p>Next Day Prediction: ₹ {nextPrice?.toFixed(2)}</p>
                    <p>After 30 Days: ₹ {day30Price?.toFixed(2)}</p>
                </div>
